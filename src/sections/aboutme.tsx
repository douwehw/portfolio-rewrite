...
export default function AboutMe() {
    return (
        <div className="mt-12 dark:text-gray-300 md:w-1/3 w-8/12 z-10" id="aboutme">
            ...
            <p className="break-words font-normal text-lg tracking-tight my-6 text-left mx-auto">
